...
def addimage(iplotpos,
    ...
    if (isinstance(Region, str)):
        ...
        if (Clevs == 'Region'):
            ...
            scatter_subim_raw = np.std(
                subim_grey[np.where(subim_region > 0.9)])
    ...
    if (isinstance(DoGreyCont, str)):
        ...
        CS = axcb.contour(subim_grey_cont,
                          levels,
                          origin='lower',
                          linewidths=1.0,
                          linestyles='solid',
...
def exec_summary(basename,
    ...
    if (isinstance(file_continuum, str)):
        ...
        Resamp.gridding(file_im_continuum,
                        basename + '_centered.fits',
                        fileout=basename + '_subimcont.fits')
...
def exec_summary_allrads(basename,
                         fileout,
                         vsyst=0.,
                         basename_errormap=False,
                         file_m0=False,
    ...
    if (isinstance(file_m0, str)):
        ...
        Resamp.gridding(file_im_m0,
                        basename + '_centered.fits',
                        fileout=basename + '_subim_m0.fits')
    ...
    if (isinstance(file_m2, str)):
        ...
        Resamp.gridding(file_im_m2,
                        basename + '_centered.fits',
                        fileout=basename + '_subim_m2.fits')
