...
workdir='work_dgauss_tclean_g_v0_Merid_noregions'

#workdir='work_dgauss_tclean_g_v0_Merid_noregions_NoErrMap'

sourcedir='/strelka_ssd/simon/HD135344B/Dmoments/12CO_dgaussmoments_constub_z_b/'


workdir='work_dgauss_tclean_g_v0_Merid_noregions_xtend'
